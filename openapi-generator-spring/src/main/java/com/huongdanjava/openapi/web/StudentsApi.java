...
public interface StudentsApi {
    ...
    String PATH_ADD_NEW_STUDENT = "/students";
    /**
    ...
    default ResponseEntity<AddNewStudentResponse> addNewStudent(
        @Parameter(name = "Student", description = "") @Valid @RequestBody(required = false) @Nullable Student student
    ) {
        return getDelegate().addNewStudent(student);
    }


    String PATH_DELETE_STUDENT_BY_ID = "/students/{id}";
    /**
    ...
    default ResponseEntity<DeleteStudentResponse> deleteStudentById(
    ...
    default ResponseEntity<GetAllStudentsResponse> getAllStudents(
        @Min(value = 1) @Parameter(name = "page", description = "Page number (1-based).", in = ParameterIn.QUERY) @Valid @RequestParam(value = "page", required = false, defaultValue = "1") Integer page,
        @Min(value = 1) @Max(value = 100) @Parameter(name = "size", description = "Number of items per page.", in = ParameterIn.QUERY) @Valid @RequestParam(value = "size", required = false, defaultValue = "10") Integer size
    ) {
        return getDelegate().getAllStudents(page, size);
    }


    String PATH_GET_STUDENT_BY_ID = "/students/{id}";
    /**
    ...
    default ResponseEntity<GetStudentByIdResponse> getStudentById(
        @Parameter(name = "id", description = "Student Id", required = true, in = ParameterIn.PATH) @PathVariable("id") String id
    ) {
    ...
    String PATH_UPDATE_STUDENT = "/students/{id}";
    /**
    ...
    default ResponseEntity<UpdateStudentResponse> updateStudent(
        @Parameter(name = "id", description = "Student Id", required = true, in = ParameterIn.PATH) @PathVariable("id") String id,
        @Parameter(name = "Student", description = "") @Valid @RequestBody(required = false) @Nullable Student student
    ) {
        return getDelegate().updateStudent(id, student);
    }
