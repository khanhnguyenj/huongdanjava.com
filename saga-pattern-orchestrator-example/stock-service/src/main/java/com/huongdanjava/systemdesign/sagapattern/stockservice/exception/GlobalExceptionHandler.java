...
import com.huongdanjava.systemdesign.sagapattern.stockservice.web.dto.InlineObject;
import com.huongdanjava.systemdesign.sagapattern.stockservice.web.dto.InlineObjectAllOfDataInner;
import com.huongdanjava.systemdesign.sagapattern.stockservice.web.dto.StockReleaseResponse;
...
public class GlobalExceptionHandler {
  ...
  @ExceptionHandler({
    ...
    ProductStockNotFoundException.class,
    StockReservationNotFoundException.class
  })
  public ResponseEntity<InlineObject> insufficientStockException(Exception ex, WebRequest request) {
